...
import { faBed, faCar, faTaxi, faPlane, faPerson } from "@fortawesome/free-solid-svg-icons";
...
const Header = () => {
    ...
    const handleOption = (name: any, operation: any): any => {
        setOptions((prev) => {

            return {
                ...prev,
                [name]: operation === "i" ? options.adult + 1 : options.adult - 1,
    ...
    const handleSearch = ()=>{
        navigate("/Pages",{state:{destination ,date,options}});
    }
                    ...
                    <div className="headerSearchItem">
                        ...
                        {openOptions && <div className="options">
                            ...
                            <div className="optionsItem">
                                ...
                                <div className="optionsCounter">
                                    <button disabled={options.children <= 1} className="optionsCounterbtn" onClick={() => handleOption("children", "d")}>-</button>
